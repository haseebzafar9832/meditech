    ...
    return Scaffold(
      ...
      body: Obx(() {
        return PageTransitionSwitcher(
          ...
          child: d!.isEmpty
              ? screens2[controller.currentBottomNavItemIndex.value]
              : screens[controller.currentBottomNavItemIndex.value],
        );
      }),
    );
  }
